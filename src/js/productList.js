import { renderListWithTemplate, calculateDiscount } from "./utils.js";
...
export default class ProductList {
  ...
  prepareTemplate(template, product) {
    ...
    if (product.IsClearance) {
      template.querySelector(".clearance").textContent = "Clearance";
    }
    ...
    if (discount > 0) {
      template.querySelector(".discount").textContent += `-${discount}%`;
    }
    return template;
  }
  renderList(list) {
